...
#include "AutoChutesRightGearCmdGrp.h"
...
AutoChutesRightGearCmdGrp::AutoChutesRightGearCmdGrp() {
// END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
	...
	AddSequential(new AutoDriveFwdCmd(85.5,     0.35,      0.35,      -0.0,     0.05,    -0.20,      3,       3,         0.0,       0.2,   5.5,   0));

	// (Angle, Speed, Timeout, Mode (0=by angle, 1=Left Side CW, 2=Right Side CCW)
	AddSequential(new DrivePointTurnCmd(10, 0.4, 8, 2));
	...
	//							   (tgtDist, accelPwr, cruisePwr, decelPwr, slowPwr, stopPwr, accelDist, decelDist, slowSpeed, stopDist, TO, Mode)
	AddSequential(new AutoDriveFwdCmd(38.75,     0.25,      0.25,      -0.0,     0.05,    -0.20,      3,       3,         0.0,       0.2,   3,   1));
