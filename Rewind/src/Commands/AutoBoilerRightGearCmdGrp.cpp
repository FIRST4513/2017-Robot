...
#include "AutoBoilerRightGearCmdGrp.h"
...
AutoBoilerRightGearCmdGrp::AutoBoilerRightGearCmdGrp() {
// END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
	...
	// 							   (tgtDist, accelPwr, cruisePwr, decelPwr, slowPwr, stopPwr, accelDist, decelDist, slowSpeed, stopDist, TO, Mode)
		AddSequential(new AutoDriveFwdCmd(87,     0.35,      0.35,      -0.0,     0.05,    -0.20,      3,       3,         0.0,       0.2,   5.5,   0));
		...
		//							   (tgtDist, accelPwr, cruisePwr, decelPwr, slowPwr, stopPwr, accelDist, decelDist, slowSpeed, stopDist, TO, Mode)
		AddSequential(new AutoDriveFwdCmd(32.0,     0.25,      0.25,      -0.0,     0.05,    -0.20,      3,       3,         0.0,       0.2,   3,   1));
