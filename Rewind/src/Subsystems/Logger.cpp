...
void Logger::logDrivetrain(){
	...
	double currAccel, leftAccel, rightAccel;
	...
	currAccel = Robot::drivetrain->GetAccel();
	leftAccel = Robot::drivetrain->GetLeftAccel();
	rightAccel = Robot::drivetrain->GetRightAccel();
	...
	if (Robot::drivetrain->MotorMode == 0){
		line += " ,Coasting";
	}
	else if (Robot::drivetrain->MotorMode == 1){
		line += " ,DriveByJoystick";
		line += " ,Drive SA=," + std::to_string(Robot::drivetrain->MotorSpeed) + "," +
								 std::to_string(Robot::drivetrain->MotorAngle);
	}
	else if (Robot::drivetrain->MotorMode == 2){
		line += " ,Drive Straight";
		line += " ,Drive SA=," + std::to_string(Robot::drivetrain->MotorSpeed) + "," +
								 std::to_string(Robot::drivetrain->MotorAngle);
	}
	else if (Robot::drivetrain->MotorMode == 3){
		line += " ,Drive To Hdg";
		line += " ,Drive SA=," + std::to_string(Robot::drivetrain->MotorSpeed) + "," +
								 std::to_string(Robot::drivetrain->MotorAngle);
	}
	else if (Robot::drivetrain->MotorMode == 4){
		line += " ,Tank Drive";
	...
	line += " ,Accel LRA=," + std::to_string(Robot::drivetrain->GetLeftAccel()) + "," +
	  	  	  	  	  	  	  std::to_string(Robot::drivetrain->GetRightAccel()) + "," +
	  	  	  	  	  	  	  std::to_string(Robot::drivetrain->GetAccel());
