...
private:
	...
	float kGyroCorrectionLwrLimit = -0.120;				// -0.035 wasnt experienced at 0.005 correction
	float kGyroCorrectionUpperLimit = 0.120;
...
public:
	...
	Timer timer;
	double lastTime, lastVelocity, currAccel;
	double lastLeftVel, lastRightVel;
