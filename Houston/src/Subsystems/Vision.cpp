...
void Vision::SetTgtFlag(int mValidTgtFlag){validTgtFlag = mValidTgtFlag;}

void Vision::SetTgtAngles(double mtgtAngleX, double mtgtAngleY){
	tgtAngleX = mtgtAngleX;
	tgtAngleY = mtgtAngleY;
}

void Vision::SetTgtDist(double mtgtDistance){ tgtDistance = mtgtDistance; }
...
void Vision::SetCurrYaw( double yaw){ currYaw = yaw; }
void Vision::SetAngleCorrection(double correction){	currAngleCorrection = correction; }
...
double Vision::GetTgtAngleY()		{ return tgtAngleY; }
...
void Vision::Update_Smartdashboard(double mode){
	...
	SmartDashboard::PutNumber("Vision tgtDist", tgtDistance);
	SmartDashboard::PutNumber("Vision  Wall Offset", tgtTransCorrection);
	SmartDashboard::PutNumber("Vision  Probe Offset", adjTgtTransCorrection);

	SmartDashboard::PutNumber("Vision tgtAngleX", tgtAngleX);
	SmartDashboard::PutNumber("Vision tgtAngleY", tgtAngleY);
	SmartDashboard::PutNumber("Vision CurrYaw", currYaw);
	SmartDashboard::PutNumber("Vision TgtCorr Angle", currAngleCorrection);
}
